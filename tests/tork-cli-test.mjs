...
const frontendNginx = await fs.readFile(path.join(root, "frontend", "nginx.conf.template"), "utf8");
...
assert(!frontendNginx.includes("X-Frame-Options"), "kanban frontend must allow Chatwoot iframe embedding");
